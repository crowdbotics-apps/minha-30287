...
admin.site.site_header = "minha"
admin.site.site_title = "minha Admin Portal"
admin.site.index_title = "minha Admin"

# swagger
api_info = openapi.Info(
    title="minha API",
    default_version="v1",
    description="API documentation for minha App",
)
